...
\newcommand{\docname}{Les very belles citations de Mr Le Duff}
\newcommand{\authorname}{Les gentils MP 2}
\newcommand{\dmy}{}
\newcommand{\years}{2020 — 2022}
\newcommand{\org}{Lycée Malherbe}
...
\section*{WTF Random}
	...
	\og L'ensemble des $\lambda$ on l'appelle le spectre, comme le méchanta dans James Bond \fg \\
